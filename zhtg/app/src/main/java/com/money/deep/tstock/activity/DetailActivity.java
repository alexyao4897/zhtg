...
import com.money.deep.tstock.model.Model;
import com.money.deep.tstock.model.StockListBean;
...
public class DetailActivity extends Activity {
    ...
    private List<CandleEntry> candleEntries = new ArrayList<CandleEntry>();
    ...
    private  void loadData(){
        DataManager.getInfo("", new Response.Listener<String>() {
            @Override
