package com.money.deep.tstock.framework.popup;
...
import com.money.deep.tstock.framework.util.ConvertUtils;
...
/*        cancelText = activity.getString(android.R.string.cancel);
        ...
        cancelText = activity.getString(R.string.cancel_str);
        submitText = activity.getString(R.string.confirm_str);
    }
