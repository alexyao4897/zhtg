...
public class DatePicker extends WheelPicker {
    ...
    public void setDayRange(int startDay,int endDay){
        ...
        System.out.println("add days:"+days.size());
    }
...
//                    }
                    ...
                    String current_day = date.substring(8, 10);
                    if(current_day.indexOf("0")==0){
                        current_day = current_day.replace("0","");
                    }
                    int size = Integer.valueOf(current_day);
                    ...
                    if(selectedMonthIndex==0){
                        System.out.println("0size:" + size);
                        for (int i = size; i <= maxDays; i++) {
                            days.add(DateUtils.fillZero(i));
                        }
                        selectedDayIndex = 0;
                        dayView.setItems(days, selectedDayIndex);
