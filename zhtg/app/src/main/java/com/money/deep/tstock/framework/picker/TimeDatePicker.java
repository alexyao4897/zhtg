 ...
 * @version 2015 /12/14
 */
public class TimeDatePicker extends WheelPicker {
    /**
     * 年月日
     */
    ...
    public static final int YEAR_MONTH_DAY_TIME = 4;
     ...
     */
    public TimeDatePicker(Activity activity) {
     ...
     */
    public TimeDatePicker(Activity activity, @Mode int mode) {
        super(activity);
        this.mode = mode;
...
//                   ((OnMonthDayPickListener) onDatePickListener).onDatePicked(month, day);
                    ((onMonthDayTimePickListener) onDatePickListener).onDatePicked(month, day,selectedHour, selectedMinute);
                    break;
                case YEAR_MONTH_DAY_TIME:
                    ((onYearMonthDayTimePickListener) onDatePickListener).onDatePicked(year, month, day, selectedHour, selectedMinute);
                    break;
                default:
    ...
    public interface onMonthDayTimePickListener extends OnDatePickListener{
        ...
        void onDatePicked(String month, String day, String hour, String minute);
    }
